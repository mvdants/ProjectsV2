...
class App{
    ...
    constructor(){
        ...
        // Metodos para registrar os eventos do form
    ...
    async adicionarRepositorio(evento){
        ...
        // Se o input voer vazio...sai da app
        if(input.length === 0){
        ...
        try{
            ...
            let txtErro = document.createTextNode(`O repositorio ${input} nao exite`);
